...
class DeviceactionsApi:
    ...
    def resume_devices(
        self,
        device_resume_request: Optional[DeviceResumeRequest],
        ...
        :param device_resume_request: (required)
        :type device_resume_request: DeviceResumeRequest
        ...
        _param = self._resume_devices_serialize(
            device_resume_request=device_resume_request,
    ...
    def _resume_devices_serialize(
        ...
        if device_resume_request is not None:
            _body_params = device_resume_request
