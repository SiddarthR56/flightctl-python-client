...
class DeviceApi:
    ...
    def decommission_device(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Device resource to decommission.")],
        ...
        :param name: The name of the Device resource to decommission. (required)
        :type name: str
        :param device_decommission: (required)
        :type device_decommission: DeviceDecommission
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._decommission_device_serialize(
            name=name,
    ...
    @validate_call
    def decommission_device_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Device resource to decommission.")],
        device_decommission: DeviceDecommission,
        _request_timeout: Union[
    ...
    @validate_call
    def decommission_device_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Device resource to decommission.")],
        device_decommission: DeviceDecommission,
        _request_timeout: Union[
    ...
    def _decommission_device_serialize(
        self,
        name,
        device_decommission,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if device_decommission is not None:
            _body_params = device_decommission
    ...
    def delete_device(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Device resource to delete.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param name: The name of the Device resource to delete. (required)
        :type name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_device(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Device resource to get.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param name: The name of the Device resource to get. (required)
        :type name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_device_last_seen(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Device resource to get the last seen timestamp for.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_device_last_seen_serialize(
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_device_last_seen_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Device resource to get the last seen timestamp for.")],
        _request_timeout: Union[
            None,
    ...
    def _get_device_last_seen_serialize(
        self,
        name,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def get_rendered_device(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Device resource to get the rendered device specification for.")],
        ...
        :param name: The name of the Device resource to get the rendered device specification for. (required)
        :type name: str
        ...
        _param = self._get_rendered_device_serialize(
            name=name,
    ...
    @validate_call
    def get_rendered_device_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Device resource to get the rendered device specification for.")],
        known_rendered_version: Annotated[Optional[StrictStr], Field(description="The last known renderedVersion.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_rendered_device_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Device resource to get the rendered device specification for.")],
        known_rendered_version: Annotated[Optional[StrictStr], Field(description="The last known renderedVersion.")] = None,
        _request_timeout: Union[
    ...
    def patch_device(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Device resource to patch.")],
        ...
        :param name: The name of the Device resource to patch. (required)
        :type name: str
    ...
    def patch_device_status(
        ...
        _param = self._patch_device_status_serialize(
            name=name,
            patch_request_inner=patch_request_inner,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def patch_device_status_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Device resource to patch.")],
        patch_request_inner: List[PatchRequestInner],
        _request_timeout: Union[
    ...
    @validate_call
    def patch_device_status_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Device resource to patch.")],
        patch_request_inner: List[PatchRequestInner],
        _request_timeout: Union[
    ...
    def _patch_device_status_serialize(
        self,
        name,
        patch_request_inner,
        _request_auth,
    ...
    def replace_device(
        self,
        name: Annotated[StrictStr, Field(description="The name of the Device resource to update.")],
        device: Device,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param name: The name of the Device resource to update. (required)
        :type name: str
        :param device: (required)
        :type device: Device
        :param _request_timeout: timeout setting for this request. If one
