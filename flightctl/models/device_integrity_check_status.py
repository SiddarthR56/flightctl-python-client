...
class DeviceIntegrityCheckStatus(BaseModel):
    """
    ...
    info: Optional[StrictStr] = Field(default=None, description="Human-readable information about the integrity check status.")
