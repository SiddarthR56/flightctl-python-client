...
class GitConfigProviderSpecGitRef(BaseModel):
    ...
    """ # noqa: E501
    repository: StrictStr = Field(description="The name of the Repository resource.")
    target_revision: StrictStr = Field(description="The revision to use from the Repository.", alias="targetRevision")
    path: StrictStr = Field(description="The path to the config in the Repository.")
