...
class FleetRolloutFailedDetails(BaseModel):
    """
    ...
    template_version: StrictStr = Field(description="The name of the TemplateVersion that this fleet rollout failed for.", alias="templateVersion")
    ...
    def detail_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['FleetRolloutFailed']):
            raise ValueError("must be one of enum values ('FleetRolloutFailed')")
        return value
