...
class OrganizationSpec(BaseModel):
    ...
    """ # noqa: E501
    display_name: Optional[StrictStr] = Field(default=None, description="Human readable name shown to users.", alias="displayName")
    external_id: Optional[StrictStr] = Field(default=None, description="External ID of the organization.", alias="externalId")
    __properties: ClassVar[List[str]] = ["displayName", "externalId"]
